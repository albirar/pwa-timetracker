...
export class CheckRegister implements CheckOperationRegister {
...
export class CheckEventImpl implements CheckEvent {
...
export interface ApiCheckRegister {
    ...
    validateManualOperation(register: CheckRegister): boolean;
...
class ApiCheckRegisterSingleton implements ApiCheckRegister {
    ...
    autoCheckOperation(): CheckOperationRegister {
        ...
        reg = new CheckRegister();
        return this.registerOp(reg);
    }
    manualCheckOperation(moment: number, operation: CheckOperation): CheckOperationRegister {
        var reg : CheckRegister;

        reg = new CheckRegister(moment, operation);
    ...
    private registerOp(reg: CheckRegister) : CheckOperationRegister {
